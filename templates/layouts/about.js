/**
 * 关于本站页面布局模板 (About Page Layout Template)
 */
        ...
        <article class="article-main-card">
          ...
          <header class="article-header">
            <div class="article-meta-row">
              <span class="post-category-tag">关于本站</span>
              <span class="meta-dot">·</span>
              <span class="post-readtime">3 分钟阅读</span>
            </div>
          ...
          <div class="prose" id="main-content">
            ...
            <ul>
              <li><strong>GitHub</strong>: <a href="${blogConfig.githubUrl}" target="_blank" rel="noopener noreferrer" style="color: var(--primary);">github.com/vmrey/vmrey.github.io</a></li>
        ...
        <aside class="article-toc-panel" aria-label="文章目录大纲">
          <div class="toc-card">
            ...
            <nav class="toc-nav">
              <ul class="toc-list">
                <li>
                  <a href="#一-博客创办初衷与核心价值" class="toc-link depth-2" title="一、博客创办初衷与核心价值">
                    <span class="toc-bullet"></span>
                    <span class="toc-text">一、博客创办初衷与核心价值</span>
                  </a>
                </li>
                <li>
                  <a href="#二-核心技术专栏矩阵" class="toc-link depth-2" title="二、核心技术专栏矩阵">
                    <span class="toc-bullet"></span>
                    <span class="toc-text">二、核心技术专栏矩阵</span>
                  </a>
                </li>
                <li>
                  <a href="#三-联系与交流方式" class="toc-link depth-2" title="三、联系与交流方式">
                    <span class="toc-bullet"></span>
                    <span class="toc-text">三、联系与交流方式</span>
                  </a>
                </li>
              </ul>
            </nav>
