...
<div class="nested-file-row standalone-file-card">
  <div class="file-row-left">
    <div class="file-type-pill" style="color: #a855f7; border-color: #a855f740; background: rgba(168, 85, 247, 0.1);">
      .SH
    </div>
    <div class="file-name-meta">
      <div class="file-name-line">
        <span class="file-main-name">cf-ddns.sh</span>
        <span class="file-size-tag">Shell 脚本</span>
      </div>
      <div class="file-desc-line" title="Cloudflare DDNS 动态域名解析自动检测与同步脚本">Cloudflare DDNS 动态域名解析自动检测与同步脚本（支持 IPv4/IPv6、智能缓存与 Crontab）</div>
    </div>
  </div>
  <div class="file-row-actions">
    <a href="../assets/files/cf-ddns.sh" download="cf-ddns.sh" class="file-action-btn primary" title="直接下载 cf-ddns.sh">
