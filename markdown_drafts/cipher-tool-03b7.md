...
<div style="background: rgba(0, 0, 0, 0.02); border: 1px solid rgba(0, 0, 0, 0.08); border-radius: 8px; padding: 16px 20px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; margin: 20px 0;">
    ...
    <div>
        <a href="https://vmrey.github.io/assets/files/cipherTool.ts" target="_blank" download style="display: inline-flex; align-items: center; gap: 6px; padding: 9px 18px; background-color: #1a73e8; color: #fff; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; transition: background 0.2s;">
            <span>📥 直接下载 cipherTool.ts 源码</span>
        </a>
    </div>
</div>
