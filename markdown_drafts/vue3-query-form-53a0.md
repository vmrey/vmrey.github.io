  ...
  <div class="file-row-left">
    ...
    <div class="file-name-meta">
      <div class="file-name-line">
        <span class="file-main-name">QueryForm.vue</span>
        <span class="file-size-tag">Vue 3 组件</span>
      </div>
      <div class="file-desc-line" title="Vue3 + Element Plus 查询表单通用封装组件源码">Vue3 + Element Plus 查询表单通用封装组件源码（响应式布局与重置联动）</div>
    </div>
  </div>
  <div class="file-row-actions">
    <a href="../assets/files/QueryForm.vue" download="QueryForm.vue" class="file-action-btn primary" title="直接下载 QueryForm.vue">
