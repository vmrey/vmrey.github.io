...
<div class="nested-file-row standalone-file-card">
  <div class="file-row-left">
    <div class="file-type-pill" style="color: #10b981; border-color: #10b98140; background: rgba(16, 185, 129, 0.1);">
      .VUE
    </div>
    <div class="file-name-meta">
      <div class="file-name-line">
        <span class="file-main-name">FileUpload.vue</span>
        <span class="file-size-tag">Vue 3 组件</span>
      </div>
      <div class="file-desc-line" title="Vue3 + Element Plus 文件上传组件源码">Vue3 + Element Plus 文件上传组件源码（支持回显、批量与手动控制提交）</div>
    </div>
  </div>
  <div class="file-row-actions">
    <a href="../assets/files/FileUpload.vue" download="FileUpload.vue" class="file-action-btn primary" title="直接下载 FileUpload.vue">
